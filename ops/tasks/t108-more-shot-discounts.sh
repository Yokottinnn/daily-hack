...
#   「全体的にもっと個数ふやしてほしい。徹底的にリサーチして増やして。」
#
# t105 で取れたのは富士急とラウンドワンだけ。**レジャー以外にも広げる。**
# ネットカフェ・水族館・展望台・ジム・飲食・宿・美容。
#
...
OUT="$RDIR/t108-more-shot-discounts.md"
mkdir -p "$RDIR"
...
BUDGET = 230.0
SEEDS = [
    "https://www.kaikatsu.jp/price/",
    "https://jiyu-kukan.com/price/",
    "https://www.tokyo-skytree.jp/ticket/",
    "https://www.sumida-aquarium.com/ticket/",
    "https://www.seaparadise.co.jp/ticket/",
    "https://www.kamogawa-seaworld.jp/guide/fee.html",
    "https://www.tipness.co.jp/",
    "https://www.gorakuyu.jp/",
    "https://www.gyukaku.ne.jp/",
    "https://travel.willer.co.jp/",
]
WANT = re.compile(r"学割|学生|料金|価格|チケット|入場|入館|会員|キャンペーン|割引")
KEY = re.compile(r"学割|学生|大学生|専門学校|学生証|"
                 r"[0-9][0-9,]*\s*円|無料|割引|通常")
