...
T1='IKEA豊洲のオープン記念キャンペーン、9/13で終わるわよ。

限定セールも5,000円以上でもらえるバッグも、そこまで。
10%オフクーポンは配布が9月で、使えるのは10月からだから注意して。

サメ（BLÅHAJ）は1,499円まで下がってた。
豊洲駅 直結で10:00〜21:00だから、仕事帰りに寄れる。'

T2='「豊洲のIKEAって何が置いてあるの」を、リビング・キッチン・収納・食品・キッズ・相談カウンターの6ゾーンに分けて 写真つきで全部見たわよ。
