...
#     今のキャラ口調と合わせてオリジナル投稿に昇華してほしい」
#     https://x.com/ryo_ryo_1008/status/2102231543402094968
#
...
S="$W/scripts"
OUT="${OPS_REPORT_DIR:-/tmp}/viral-post-structure.md"
RUNNER="$S/.x130-viral.js"
...
const AUTHOR = "ryo_ryo_1008";
const TARGET = "2102231543402094968";
const MAX_RECENT = 10;
...
{
echo "# バズ投稿の構造を読む（$(date '+%Y-%m-%d %H:%M') JST・費用 \$0）"
echo
...
echo "バズ投稿の構造を読んだ / $(basename "$OUT") $(wc -l < "$OUT" | tr -d ' ') 行"
