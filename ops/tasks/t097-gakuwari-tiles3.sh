...
OUT="$RDIR/t097-gakuwari-tiles3.md"
DIR="$RDIR/gakuwari-tiles3"
mkdir -p "$DIR"
...
THEMES = [
    ("cinema", ["movie theater seats", "cinema hall red seats", "映画館 スクリーン"]),
    ("train",  ["Shinkansen station platform train", "N700 series Shinkansen", "新幹線 ホーム"]),
    ("design", ["laptop computer desk workspace", "computer desk office", "デスク パソコン"]),
]
