...
OUT="$RDIR/t096-gakuwari-tiles2.md"
DIR="$RDIR/gakuwari-tiles2"
mkdir -p "$DIR"
...
THEMES = [
    ("cinema", ["cinema auditorium", "映画館 客席"]),
    ("design", ["designer working laptop", "ノートパソコン 作業"]),
    ("music",  ["headphones music", "ヘッドホン"]),
    ("train",  ["Shinkansen", "新幹線"]),
    ("museum", ["museum gallery interior", "美術館 展示室"]),
    ("books",  ["bookstore interior", "書店 店内"]),
]
