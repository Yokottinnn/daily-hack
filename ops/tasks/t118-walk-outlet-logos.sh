#!/bin/bash
# **歩いてポイ活とアウトレット記事のロゴを取る（20 ブランド・t118）。**
#
...
OUT="$RDIR/t118-walk-outlet-logos.md"
DIR="$RDIR/walk-outlet-logos"
mkdir -p "$DIR"
...
man = {"_note": "識別目的で使うロゴ。**商標であり自由ライセンスではない。**改変せず、"
                "余白のみ切って置くこと。取得日 " + dt.date.today().isoformat() + "（" + "ops/tasks/t118-walk-outlet-logos.sh" + "）。"}
t0 = time.time()
...
BRANDS = [
    ("jal", "JAL Wellness & Travel", "https://www.jal.co.jp/jp/ja/jmb/wellness/", [("commons.wikimedia.org", "File:Japan Airlines logo (2011).svg")]),
    ("ana", "ANA Pocket", "https://www.ana.co.jp/ja/jp/guide/ana-pocket/", [("commons.wikimedia.org", "File:All Nippon Airways Logo.svg")]),
    ("torima", "トリマ", "https://www.trip-mile.com/", []),
    ("rakutenhealth", "楽天ヘルスケア", "https://healthcare.rakuten.co.jp/", [("commons.wikimedia.org", "File:Rakuten Global Brand Logo.svg")]),
    ("dhealth", "dヘルスケア", "https://healthcare.smt.docomo.ne.jp/", [("ja.wikipedia.org", "ファイル:NTT docomo logo.svg")]),
    ("arucoin", "アルコイン", "https://www.agoop.co.jp/", []),
    ("renobody", "RenoBody", "https://info.renobody.jp/prod/index.html", []),
    ("pixela", "ピクセラ", "https://www.pixela.co.jp/", []),
    ("rakutensenior", "楽天シニア", "https://senior.rakuten.co.jp/", []),
    ("sugi", "スギサポwalk+", "https://www.sugi-net.jp/sugisapo/", []),
    ("arukuto", "aruku&", "https://www.arukuto.jp/", []),
    ("vitality", "住友生命 Vitality", "https://vitality.sumitomolife.co.jp/", [("ja.wikipedia.org", "ファイル:Sumitomo Life logo.svg")]),
    ("kencom", "kencom", "https://kencom.jp/", []),
    ("uplus", "東京健康UPlus", "https://kenkou-uplus.metro.tokyo.lg.jp/", []),
    ("cokeon", "Coke ON", "https://c.cocacola.co.jp/app/", [("commons.wikimedia.org", "File:Coca-Cola logo.svg")]),
    ("premium", "プレミアム・アウトレット", "https://www.premiumoutlets.co.jp/", []),
    ("mitsui", "三井ショッピングパーク", "https://mitsui-shopping-park.com/", [("ja.wikipedia.org", "ファイル:Mitsui Fudosan logo.svg")]),
    ("karuizawa", "軽井沢・プリンスショッピングプラザ", "https://www.karuizawa-psp.jp/", []),
    ("hiroshima", "THE OUTLETS HIROSHIMA", "https://the-outlets-hiroshima.com/", []),
    ("aeonmall", "イオンモール", "https://www.aeonmall.com/", [("ja.wikipedia.org", "ファイル:AEON MALL logo.svg")]),
]
