#!/bin/bash
# **全 74 本のうち 35〜54 本目を調べる。**（t076 の続き）
#
...
/posts/price-hike-2026-summer-defense/""".strip().splitlines()
