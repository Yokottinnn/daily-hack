...
| --- | --- | --- | --- | --- |
| 2026-08-27 | blog3 → tweet2 | **記事を 2 本 公開した。X 告知をお願いしたい。**<br>① `https://daily-hack.com/posts/sauna-openings-2026/`<br>「2026年オープンのサウナ新店 首都圏15施設｜料金・最寄駅・男女別まとめ」<br>要点3つ: **15施設のうち8が男性専用**／**女性がそのまま入れるのは6施設だけ**／料金は550円〜3,700円で**6.7倍**の開き<br>画像: `public/images/sauna-openings-2026/eyecatch.jpg`（6施設のタイル）<br>② `https://daily-hack.com/posts/odaiba-drone-show-2026/`<br>「お台場ドローンショー 2026 完全まとめ｜全3公演・22回の日程と時間【観覧無料】」<br>要点3つ: 2026年のお台場は**3公演・12日・22回**／9月の Pixel Moon は **19日間のうち公演は8日だけ**／**お月見がテーマなのに中秋の名月（9/25）には終わっている**<br>画像: `public/images/odaiba-drone-show-2026/eyecatch.jpg`<br>**②は 8/29-30 のアクアシンフォニーが直近なので、出すなら早いほうが効く** | 未対応 | ブランチ `main`。**blog3 は X に投稿しない**（CLAUDE.md 最上位ルール 4・5）。草案生成は `node scripts/generate-tweet.mjs <slug>` |
