...
<div class="flow-steps">
  <div class="flow-step"><strong>あんたが寄付</strong>：年収に応じた上限額の範囲内で、自治体Aに <strong>30,000円</strong> を寄付する</div>
  <div class="flow-step"><strong>返礼品が届く</strong>：自治体Aから米10kg、肉2kg、海鮮セットなどが配送される</div>
  <div class="flow-step"><strong>翌年に控除</strong>：住民税・所得税から <strong>28,000円が控除</strong>される（自己負担2,000円のみ）</div>
  <div class="flow-step"><strong>結果</strong>：実質2,000円で30,000円分の品が手に入る</div>
</div>
...
ここを間違うと「ただの寄付」になって損するから、**最優先で計算しなさい**。

### 年収別の目安（独身・扶養なしの場合）

<div class="income-grid">
  <div class="income-row">
    <span class="income-label">年収 300万</span>
    <div class="income-bar short"></div>
    <span class="income-value">約 ¥28,000</span>
  </div>
  <div class="income-row">
    <span class="income-label">年収 400万</span>
    <div class="income-bar s2"></div>
    <span class="income-value">約 ¥42,000</span>
  </div>
  <div class="income-row">
    <span class="income-label">年収 500万</span>
    <div class="income-bar s3"></div>
    <span class="income-value">約 ¥61,000</span>
  </div>
  <div class="income-row">
    <span class="income-label">年収 600万</span>
    <div class="income-bar s4"></div>
    <span class="income-value">約 ¥77,000</span>
  </div>
  <div class="income-row">
    <span class="income-label">年収 700万</span>
    <div class="income-bar s5"></div>
    <span class="income-value">約 ¥108,000</span>
  </div>
  <div class="income-row">
    <span class="income-label">年収 800万</span>
    <div class="income-bar s6"></div>
    <span class="income-value">約 ¥129,000</span>
  </div>
  <div class="income-row">
    <span class="income-label">年収 1,000万</span>
    <div class="income-bar s7"></div>
    <span class="income-value">約 ¥180,000</span>
  </div>
</div>

<p class="source-note">出典: 総務省「ふるさと納税ポータルサイト」全額控除されるふるさと納税額（年間上限）の目安より独身・給与所得者ケースを抜粋（<a href="https://www.soumu.go.jp/main_sosiki/jichi_zeisei/czaisei/czaisei_seido/furusato/mechanism/deduction.html" target="_blank" rel="noopener nofollow">soumu.go.jp</a>）。共働き・扶養家族あり・住宅ローン控除・医療費控除等を使ってる人は変動します。</p>
...
「源泉徴収票どこ行ったかわからない」ってあんた、それはまず探しなさい。話はそこから。

### 上限の8割で運用するのが安全

控除上限ギリギリまで攻めて、もし年収が予想より下がってたら超過分は自腹になる。<strong>上限の80〜90%</strong>で運用するのが鉄則。残りの10〜20%は12月のボーナス額が確定してから追加寄付すればいい。
...
### ⚠️ 2025年10月以降、仲介サイトのポイント還元は禁止されている

ここ、めちゃくちゃ重要だから絶対に押さえて。**2025年10月から、ふるさと納税ポータルサイトが付与していたポイント還元（楽天ポイント大量還元・PayPayボーナス・ふるなびコイン等）は全面禁止された**のよ。だから「楽天ふるさと納税のお買い物マラソンで30%還元」みたいな話は**過去のもの**。

> 📰 **ソース**: [Yahoo!ニュース「ふるさと納税のポイント還元、2025年10月以降は受けられなくなる」（2026年5月配信）](https://news.yahoo.co.jp/articles/c21c95237e5e9bd4f3e0fe21a319c9e3fe9e6ef4)。総務省の制度見直しによる規制で、各仲介サイトのポイント付与キャンペーンが終了している。

ただし以下は **存続している還元** だから安心して:

- **クレジットカード決済時のクレカ側ポイント**（楽天カードで決済 → 楽天ポイント、PayPayカードで決済 → PayPayポイント、等）
- **ANAマイル・auポイントなど、サイト独自のサービス連動還元**（自治体提供の還元ではなく外部経済圏連動）

要するに、**サイト固有の「お買い物マラソン20%還元」「PayPayステップで上乗せ」みたいなのは終了**だが、**普通に手元のクレカで決済すれば、クレカ側のポイントは普通に貯まる**。

### 結論: 取扱自治体数 + UX + 決済の便利さで選ぶ

ポイント還元が無くなった今、選定軸は3つ:

1. **取扱自治体数**: 欲しい返礼品の自治体があるか。最多はふるさとチョイス。
2. **UX・操作性**: 初心者ならさとふる、楽天会員なら楽天ふるさと納税、auユーザーなら au PAY ふるさと納税。
3. **独自連動**: ANAマイル貯めたいなら ANAのふるさと納税、家電狙いならふるなび。

迷ったら **「自分が普段使ってるサービスの ID で決済できるサイト」** を選ぶのが正解。楽天会員なら楽天、PayPayユーザーならさとふる、auユーザーなら au PAY、ANAマイル民なら ANA。決済 ID を新たに作る手間が省けて、申込が3分で終わる。
...
<div class="figure-grid">
  <div class="figure-card">
    <div class="figure-image"><img src="https://images.unsplash.com/photo-1586201375761-83865001e31c?w=900&q=80" alt="食品の返礼品" loading="lazy" /></div>
    <div class="figure-body">
      <h4>食品｜米・肉・冷凍シーフード</h4>
      <p>定番にして最強。ハズレが少ない。米10〜20kg、小分け冷凍肉、ホタテ・うなぎ・カニ。単価が高い品ほど還元率の体感が大きい。</p>
    </div>
  </div>
  <div class="figure-card">
    <div class="figure-image"><img src="https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=900&q=80" alt="日用品の返礼品" loading="lazy" /></div>
    <div class="figure-body">
      <h4>日用品｜TP・洗剤・ティッシュ</h4>
      <p>地味だけど効く。<strong>絶対に使い切る品</strong>を寄付で取れば、家計が確実に楽になる。トイレットペーパー1年分とか普通に届く。</p>
    </div>
  </div>
  <div class="figure-card">
    <div class="figure-image"><img src="https://images.unsplash.com/photo-1518770660439-4636190af475?w=900&q=80" alt="電化製品の返礼品" loading="lazy" /></div>
    <div class="figure-body">
      <h4>電化製品・PC周辺｜ふるなび一強</h4>
      <p>家電系はふるなびに集中。型落ちのプリンタ・モニタ・スピーカーあたりが狙い目。還元率は食品より低めなので、<strong>食品で枠を埋めてから余りで家電</strong>の順序がベスト。</p>
    </div>
  </div>
</div>
...
<div class="cmp-table-wrap">
  <table class="cmp-table spec-table">
    <tbody>
      <tr><th>食品（米10〜20kg）</th><td>1万円寄付で10kg前後。年間40kg食べる人は4万円を米で固定するだけで自己負担2,000円</td></tr>
      <tr><th>食品（牛肉・豚肉の小分け冷凍）</th><td>解凍してすぐ使える小分けタイプを選んで。塊肉は処理が地獄</td></tr>
      <tr><th>食品（海鮮）</th><td>ホタテ・うなぎ・カニ。冷凍庫の容量と相談しなさい</td></tr>
      <tr><th>日用品</th><td>TP・洗剤・ティッシュは「絶対に使い切る品」だから家計が浮く</td></tr>
      <tr><th>電化製品</th><td>ふるなびのプリンタ・モニタ・スピーカー。<strong>食品で枠を埋めてから余りで家電</strong>の順序がベスト</td></tr>
    </tbody>
  </table>
</div>
...
<div class="vs-pair">
  <div class="vs-card primary">
    ...
    <ul>
      <li>会社員（給与所得のみ）</li>
      <li>年間寄付先が <strong>5自治体以内</strong></li>
      <li>医療費控除・住宅ローン初年度などの他申告が無い</li>
      <li>手続きは申請書の郵送 or オンライン申請だけ</li>
    </ul>
  </div>
  <div class="vs-card">
    <h4>確定申告</h4>
    <ul>
      <li>自営業・フリーランス（元々確定申告してる人）</li>
      <li>寄付先が <strong>6自治体以上</strong></li>
      <li>医療費控除・住宅ローン初年度・株式譲渡などの併用あり</li>
      <li>2月16日〜3月15日に税務署 or e-Tax で提出</li>
    </ul>
  </div>
</div>

ポイントは<strong>「5自治体以内ならワンストップで超ラク」</strong>。6自治体目を申し込んだ瞬間に確定申告コースに乗り換わるから、自治体数のカウントは気をつけて。同じ自治体に2回寄付しても1自治体扱いだから、その点は安心。
...
これだけ。**今やりなさいよ**。年末になって慌てる人を、毎年何百万人と見てきた。あんたはその一人にならないで。
