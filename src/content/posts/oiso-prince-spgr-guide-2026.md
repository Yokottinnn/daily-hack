...
しかも**Seibu Prince Global Rewards（旧SEIBU PRINCE CLUB）に無料登録するだけで、宿泊もプールもレストランも全部ベストレート保証**。階層を上げれば**大磯ロングビーチに1日4枚無料パス**まで付いてくる。アタシみたいに毎月の旅行費を3万円台に抑えたい人は、これ読まないと無理。
...
神奈川県大磯町・西湘バイパスすぐ。**相模湾を一望する10階建てのリゾートホテル**で、目玉は次の3つ:

- **THERMAL SPA S.WAVE のインフィニティプール**（中学生以上限定／海と水面が一体化）
- **大磯ロングビーチ**（9プール＋500m流れるプール／首都圏最大級）
- **THERMAL TRIP**（温泉×サウナ×水風呂を回遊する温冷交代浴施設）

「箱根まで行くと混雑がエグい」「熱海は値段がインフレ」って嘆く湾岸ファミリー層、**東京駅から東海道線で約1時間・小田原行きで一発**の大磯はマジで穴場。
...
## 大磯ロングビーチ｜首都圏最大級のプール、SPGR会員で家族割

夏季限定（例年7月初旬〜9月初旬）で営業する**首都圏最大級の屋外プール群**。全長約1kmにわたる敷地に9プール構成、流れるプール500m・スライダー・波のプール・幼児プールまで揃ってる湘南の聖地（出典: [大磯ロングビーチ公式](https://www.princehotels.co.jp/pool/oiso/)）。
...
- 一般大人 ¥4,400〜¥4,900
- **SPGR Blue以上で大人￥700引き**（小学生・シニア・幼児は￥300引き）
- **ホテル宿泊者は半額**
...
2024年4月25日に共通プログラム化された西武・プリンスホテルズ＆リゾーツの**会員プログラム**。**年会費・入会金 完全無料**。アプリ登録だけでスタート。
...
「1メダル＝税・サ込￥10,000利用」で付与。**1〜12月の累計で翌月10日に昇格**。前年達成者には毎年4月にボーナスメダル（Diamond +20／Platinum +5／Gold +2）が自動付与されるから、**一度上げると翌年もキープしやすい仕組み**になってる。
...
| 客室アップグレード（空室時） | — | — | — | **◯** |
| クラブラウンジアクセス | — | — | — | **◯** |
| ボーナスメダル（前年達成翌4月） | — | +2 | +5 | +20 |

出典: [Seibu Prince Global Rewards ティアステータス](https://www.seibuprince.com/loyalty/tier-status)（最新の公式表記を確認推奨）
...
公式情報をベースに、大磯プリンスホテル限定で効く特典をまとめると:
...
「年200万も使わないし、Diamondは無理」と思ってるあんた、**まずはGold〜Platinumを狙うのが現実解**。

### ケースA: 年1回 大磯滞在（家族4人・1泊2万円・プール利用）

- 宿泊: ¥20,000（Blueでも公式ベストレート3%還元= ¥600分ポイント）
- 大磯ロングビーチ: 一般¥4,500 × 4人 = ¥18,000 → 宿泊者半額で ¥9,000 → **Platinum無料パス利用で ¥0**
- 朝食ビュッフェ: ¥3,500 × 2人 = ¥7,000 → **Platinumなら ¥0**

→ Platinum昇格してれば**1回の滞在で¥16,000+ポイント分得**
...
1. **[Seibu Prince Global Rewards 公式](https://www.seibuprince.com/loyalty)** にアクセス
2. メールアドレスでアカウント作成（年会費・入会金 完全無料）
3. アプリ（iOS / Android）ダウンロード推奨。会員番号・QR・ポイント残高がアプリで完結
4. ホテル予約は**公式サイト/アプリ経由**でないとベストレート保証＆ポイント還元対象外になるので注意
...
▶ **[Seibu Prince Global Rewards 公式サイトはこちら](https://www.seibuprince.com/loyalty)**（年会費無料）
▶ **[大磯プリンスホテル 公式予約はこちら](https://www.princehotels.co.jp/oiso/)**（公式ベストレート保証）
...
<aside class="related-block">
  <div class="related-block-head">
    ...
    <p class="related-block-title">続けて読むと旅費がもっとラクになる</p>
  </div>
  <ul class="related-block-list">
    ...
    <li><a href="/posts/wangan-saving-spots-2026/">
      ...
      <span class="related-block-body">
        ...
        <span class="related-block-name">湾岸エリア在住が選ぶ、家計をラクにする神スポット8選</span>
      </span>
    </a></li>
  </ul>
</aside>

※本記事は2026年5月時点の公開情報をもとに作成しています。SPGR の特典内容・到達条件・料金は変更される場合があります。最新情報は必ず [Seibu Prince Global Rewards 公式](https://www.seibuprince.com/loyalty) および [大磯プリンスホテル公式](https://www.princehotels.co.jp/oiso/) で確認してください。
