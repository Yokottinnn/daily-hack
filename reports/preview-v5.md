# 動いている呼び出し方を読んでから書かせる（2026-09-04 22:59:34 JST）
...
> はま寿司のクーポン、300円ちょいでそのセット組めるんだ。まぐろと塩辛いサーモンの組み合わせ、アタシも好きなやつだわ。

- 共有した語: `寿司, クーポン, 300, セット, サーモン`
...
```
生成側が skip: マックの食事報告は節約というより単なる食事記録で、こちらから足す情報がない。500円が得かどうかは相手の条件次第なので金額の判定もできない
```
...
```
PR/アフィリ/拡散キャンペーンの投稿なので LLM を呼ばずに見送る: r10.to / 山分け / 貰える！
```
...
> 【楽天スーパーセール】#PR この後20:00～、はちみつ紅茶他、全品半額！  https:// a.r10.to/hkBhjL  ・はちみつ紅茶2箱 50包半�
...
> 【楽天スーパーセール】#PR この後20:00～、開始２時間限定あれこれ最大半額！  ■atrise雑貨50%OFFで自転車カバー1,190円etc
...
> 2026.09.04 #新NISA 口座に買い付け中 #株クラの輪を広げよう どんどん円高に向かうんですかね 今日も持株数アップの為に�

**返信しない**

```
生成側が skip: 株の銘柄選択や購入判断について、相手の条件を知らないのに言い切ることはできない。また、何も足せる情報がない
```
...
> 【楽天スーパーセール】#PR この後20:00～、adidas公式店、スニーカー他50%OFF&ポイント20倍  https:// a.r10.to/hNFyPT ※日替わり�
...
> PayPayポイント交換も追加するとこうなる↓

**返信しない**

```
生成側が skip: 投稿の具体的な中身がない。『こうなる↓』と言いながら、実際の内容や数字・状況が見えていない
```
...
> こんにちは☁ 今日は10時半まで起き上がれず 鉛のような身体です。  ただ、スーパー買い出し 雨☔の中行きました。  �

**返信しない**

```
PR/アフィリ/拡散キャンペーンの投稿なので LLM を呼ばずに見送る: #ad
```
...
> 楽天モバイル紹介キャンペーン ①300万ポイント山分け ②楽天市場1,000円OFFクーポン  拡散（ログインしてもらうだけ）�
...
**LLM を呼んだ回数: 4 回**（PR/アフィリは入口で落ちるので候補数より少ない）
