...
**「この記事はどの語で上位に出ているか」を見るための表。**
記事単位の平均順位は語ごとの順位を混ぜた値なので、
どの語で勝っているかは記事の平均順位からは分からない。
...
記事全体: 平均 26.6 位 / 表示 7 / クリック 2

| 平均順位 | 表示 | クリック | クエリ |
| --- | --- | --- | --- |
| 80.5 位 | 2 | 1 | paypay 改悪 乗り換え |

### `/author/`

記事全体: 平均 9.3 位 / 表示 6 / クリック 0
...
| 118.0 位 | 1 | 0 | `/posts/summer-electricity-saving-2026/` |
